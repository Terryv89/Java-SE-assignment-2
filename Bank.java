...
public class Bank {
    ...
    public  ArrayList<User> getUsers() {
        ...
        ArrayList<Accounts> terrysAccount = new ArrayList<>();
        terrysAccount.add(new Accounts("1337", 2000));
        terrysAccount.add(new Accounts("4903", 3000));
        User terry = new User("Terry", "banker", terrysAccount);
